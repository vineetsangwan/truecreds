...
function parseTable(block) {
  ...
  let html =
    '<div class="bp-table-hint">👆 Swipe to see more →</div><div class="bp-table-wrap"><table class="bp-table"><thead><tr>';
...
function markdownToHtml(md) {
  ...
  html = html
    .replace(/<p><div class="bp-table-wrap">/g, '<div class="bp-table-wrap">')
    .replace(/<\/div><\/p>/g, "</div>");
  return html;
}
...
export default function BlogPost() {
  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      ...
      const stickyEnd =
        articleColBottom - boxHeight - BOTTOM_GAP - NAVBAR_OFFSET; // scroll position where it should stop
      ...
      if (scrollY < stickyStart) {
        ...
        setSidebarStyle({
          position: "absolute",
          top: articleColHeight - boxHeight,
          left: 0,
          width: "100%",
        });
      }
  ...
  return (
    <PageTransition>
      ...
      <style>{`
        ...
        @media(max-width: 640px) {
          .bp-outer-pad { padding-left: var(--site-pad) !important; padding-right: var(--site-pad) !important; }
        }
        ...
        @media(max-width: 640px) {
          ...
          /* Article card: strip all card chrome, become a plain full-bleed block.
             --site-pad is the ONLY padding value used anywhere in this block —
             every full-bleed element below cancels exactly this same amount, from
             one shared source, so it can never silently drift out of sync with the navbar. */
          .bp-article-card {
            background: transparent !important;
            border: none !important;
            border-radius: 0 !important;
            box-shadow: none !important;
            padding: var(--site-pad) 0 !important;
            margin: 0 calc(-1 * var(--site-pad)) !important;
            width: calc(100% + (2 * var(--site-pad))) !important;
          }
          /* Text content gets the padding back so it doesn't touch screen edges */
          ...
          >
            <span style={{ display: "flex", alignItems: "center", gap: "6px" }}>
              ...
              <strong style={{ color: "rgba(255,255,255,0.95)" }}>
                TrueCreds Editorial Team
              </strong>
            </span>
            <span style={{ display: "flex", alignItems: "center", gap: "6px" }}>
              ✅ Reviewed by{" "}
              <strong style={{ color: "rgba(255,255,255,0.95)" }}>
                TrueCreds Financial Experts
              </strong>
            </span>
          </div>
            ...
            <div className="bp-article-col" ref={articleColRef}>
              ...
              >
                ...
                <div>
                  ...
                  >
                    Written and fact-checked by the{" "}
                    <strong>TrueCreds Editorial Team</strong>. Loan and credit
                    terms change often — figures are indicative and you should
                    confirm current rates and charges with the lender before
                    applying.
                  </p>
                  <div
                    style={{
              ...
              >
                ...
                >
                  <strong>Disclaimer:</strong> TrueCreds.in is a loan comparison
                  platform and does not directly lend, disburse, or provide any
                  financial products. We aggregate and display loan offers from
                  RBI-registered banks and NBFCs to help you make an informed
                  decision. All loan applications are processed directly by the
                  respective lender. Interest rates, charges, eligibility, and
                  terms shown are indicative and subject to the lender's final
                  assessment. Please read the lender's terms and conditions
                ...
                style={{
                  ...
                  maxHeight:
                    sidebarStyle.position === "fixed"
                      ...
                      : "none",
                  overflowY:
                    sidebarStyle.position === "fixed" ? "auto" : "visible",
                  overflowX: "hidden",
                  scrollbarWidth: "thin",
                }}
              >
                <div style={{ padding: "24px" }}>
                  ...
                  >
                    Get matched with top lenders in 2 minutes
                  </p>
