...
import { organizationSchema, buildFaqSchema } from "../lib/schema";
...
function IllustrationCoins() {
  return (
    ...
    >
      <circle cx="40" cy="70" r="28" fill="#1565C0" />
      <circle cx="40" cy="70" r="22" fill="#0288D1" />
      <text
        x="40"
        y="75"
        textAnchor="middle"
      ...
      <circle cx="80" cy="50" r="22" fill="#1565C0" />
      <circle cx="80" cy="50" r="17" fill="#0288D1" />
      <text
        x="80"
        y="55"
        textAnchor="middle"
      ...
      <circle cx="95" cy="85" r="14" fill="#1565C0" />
      <circle cx="95" cy="85" r="10" fill="#0288D1" />
      <text
        x="95"
        y="89"
        textAnchor="middle"
...
function IllustrationChart() {
  return (
    ...
    >
      <rect x="10" y="60" width="18" height="35" rx="4" fill="#1565C0" />
      <rect x="36" y="40" width="18" height="55" rx="4" fill="#0288D1" />
      <rect x="62" y="25" width="18" height="70" rx="4" fill="#1565C0" />
      <rect x="88" y="45" width="18" height="50" rx="4" fill="#0288D1" />
      <rect x="114" y="15" width="18" height="80" rx="4" fill="#1565C0" />
      <line x1="5" y1="95" x2="135" y2="95" stroke="#1565C0" strokeWidth="2" />
      <polyline
        points="19,60 45,40 71,25 97,45 123,15"
        stroke="#0288D1"
        strokeWidth="2"
        fill="none"
        strokeDasharray="4,3"
...
function IllustrationShield() {
  return (
    ...
    >
      <path
        d="M50 10 L90 28 L90 62 C90 82 72 98 50 108 C28 98 10 82 10 62 L10 28 Z"
        fill="#1565C0"
      />
      <path
        d="M50 22 L80 36 L80 63 C80 78 67 91 50 99 C33 91 20 78 20 63 L20 36 Z"
        fill="#0288D1"
      />
      <polyline
        points="35,60 45,70 65,48"
        stroke="white"
        strokeWidth="5"
        fill="none"
        strokeLinecap="round"
...
function IllustrationPhone() {
  return (
    ...
    >
      <rect x="8" y="5" width="64" height="120" rx="12" fill="#1565C0" />
      <rect x="14" y="14" width="52" height="100" rx="8" fill="#0288D1" />
      <rect
        x="22"
        y="24"
        width="36"
...
const CATEGORIES = [
  {
    ...
    desc: "For any purpose, instant disbursal",
  },
  {
    slug: "student",
    icon: "🎓",
    title: "Student Loans",
    desc: "Education & college expenses",
  },
  {
    slug: "business",
    icon: "🏢",
    title: "Business Loans",
    desc: "SME & working capital",
  },
  {
    slug: "aadhaar",
    icon: "🪪",
    title: "Aadhaar Loans",
    desc: "Minimal KYC, fast approval",
  },
  {
    slug: "no-cibil",
    icon: "📊",
    title: "No CIBIL Loans",
    desc: "Low or zero credit score",
  },
  {
    slug: "instant",
    icon: "⚡",
    title: "Instant Loans",
    desc: "Money in minutes, not days",
  },
];
const CITIES = [
...
const TESTIMONIALS = [
  {
    name: "Priya Mehta",
    city: "Mumbai",
    text: "Got ₹3 lakh approved in under an hour. TrueCreds saved me from a high-interest trap.",
    rating: 5,
  },
  {
    name: "Rohit Sharma",
    city: "Delhi",
    text: "CIBIL was 620 and rejected everywhere. TrueCreds showed me KreditBee — got the loan same day.",
    rating: 5,
  },
  {
    name: "Ananya Singh",
    city: "Jaipur",
    text: "The EMI calculator helped me pick the right tenure. Transparent, honest, zero spam.",
    rating: 5,
  },
];
const FAQS = [
  {
    q: "Is TrueCreds a lender?",
    a: "No. TrueCreds is a comparison platform. We help you find loans from RBI-registered NBFCs and banks. We never lend money directly.",
  },
  {
    q: "Will checking eligibility affect my CIBIL?",
    a: "Absolutely not. Our eligibility check is a soft inquiry only — zero impact on your CIBIL score.",
  },
  {
    q: "Which loan types does TrueCreds compare?",
    a: "Personal, student, business, Aadhaar-based, instant loans, and loans for low/no CIBIL profiles.",
  },
  {
    q: "How are lenders ranked?",
    a: "By a weighted score: interest rate (40%), approval speed (25%), CIBIL flexibility (20%), user ratings (15%).",
  },
  {
    q: "Is my data safe?",
    a: "Yes. Bank-grade encryption. We never sell your data. Used only to match you with lenders.",
  },
];
const LENDERS = [
...
const CIBIL_RANGES = [
  ...
  },
  {
    ...
    label: "Good",
    color: "#2563eb",
    lenders: "Navi, Bajaj, MoneyTap, KreditBee",
    pct: 80,
  },
  {
    range: "650–699",
    label: "Fair",
    color: "#d97706",
    lenders: "KreditBee, LazyPay, CASHe",
    pct: 55,
  },
  {
    range: "600–649",
    label: "Low",
    color: "#dc2626",
    lenders: "KreditBee, LazyPay, mPokket",
    pct: 35,
  },
  {
    range: "No Score",
      ...
      <div>
        {[
          ...
          <div key={s.label} style={{ marginBottom: "24px" }}>
            ...
            >
              <span
                style={{ fontSize: "13px", color: "#3B5280", fontWeight: 500 }}
              >
                {s.label}
              </span>
              <span
        ...
        >
          {[
            { label: "Total Amount", val: `₹${total.toLocaleString("en-IN")}` },
            {
              ...
              val: `₹${interest.toLocaleString("en-IN")}`,
            },
...
function LoanSlider() {
  ...
  const eligible = LENDER_DATA.filter(
    ...
    <div>
      ...
      >
        <div style={{ marginBottom: "16px" }}>
          ...
          >
            <span
              style={{ fontSize: "14px", color: "#3B5280", fontWeight: 500 }}
            >
      ...
      <div style={{ marginBottom: "12px", fontSize: "13px", color: "#3B5280" }}>
        <span style={{ fontWeight: 700, color: "#1565C0", fontSize: "18px" }}>
          {eligible.length}
        </span>{" "}
        lenders can give you {formatAmt(amount)}
      </div>
      <div
        className="lender-avail-grid"
        style={{
          display: "grid",
          ...
          return (
            <div
              ...
              style={{
                padding: "12px",
                borderRadius: "12px",
                border: `1.5px solid ${ok ? "rgba(21,101,192,0.3)" : "rgba(0,0,0,0.06)"}`,
                background: ok ? "rgba(21,101,192,0.06)" : "rgba(0,0,0,0.02)",
                opacity: ok ? 1 : 0.4,
                transition: "all 0.3s",
              }}
            >
...
function LoanQuiz() {
  ...
  const questions = [
    {
      q: "What is your loan purpose?",
      key: "purpose",
      options: ["Personal/Emergency", "Education", "Business", "Instant cash"],
    },
    {
      q: "What is your employment type?",
      key: "employment",
      options: ["Salaried", "Self-employed", "Student", "Freelancer"],
    },
    {
      q: "What is your CIBIL score range?",
      key: "cibil",
      options: ["750+", "650–749", "550–649", "No score / unsure"],
    },
  ];

  const getResult = (a) => {
    if (a.cibil === "750+" && a.employment === "Salaried")
      return {
        name: "Navi",
        emoji: "🚀",
        rate: "9.9%",
        reason: "Best rate for salaried with good CIBIL",
        link: "/loans/personal",
      };
    if (a.purpose === "Education")
      return {
        name: "Credila",
        emoji: "📚",
        rate: "10.5%",
        reason: "Specialised in education loans",
        link: "/loans/student",
      };
    if (a.purpose === "Business")
      return {
        ...
        emoji: "🧾",
        rate: "14%",
        reason: "Best for SME working capital",
        link: "/loans/business",
      };
    if (a.employment === "Student")
      return {
        ...
        emoji: "🎓",
        rate: "24%",
        reason: "Only lender for students",
        link: "/loans/student",
      };
    if (a.cibil === "No score / unsure" || a.cibil === "550–649")
      return {
        name: "KreditBee",
        emoji: "🐝",
        rate: "17%",
        reason: "Accepts zero credit history",
        link: "/loans/no-cibil",
      };
    return {
      name: "MoneyTap",
      emoji: "💧",
      rate: "13%",
      reason: "Flexible credit line, wide eligibility",
      link: "/loans/personal",
    };
  };
        ...
        <button
          onClick={() => {
            const text = encodeURIComponent(
              `I matched with ${result.name} at ${result.rate} p.a. on TrueCreds! Find your best loan match too: https://truecreds.in`,
            );
        ...
        {questions.map((_, i) => (
          <div
            ...
            style={{
              ...
              height: "4px",
              borderRadius: "4px",
              background: i <= step ? "#1565C0" : "rgba(21,101,192,0.15)",
        ...
        {q.options.map((opt) => (
          <motion.button
            ...
            onMouseLeave={(e) => {
              ...
              e.currentTarget.style.background = "rgba(21,101,192,0.04)";
            }}
          >
            {opt}
          </motion.button>
...
export default function Home() {
  ...
  return (
    <PageTransition>
      <SEO
        title="Compare Best Instant Personal Loan Apps in India (2026) | TrueCreds"
        description="Compare 12+ RBI-registered loan apps by interest rate, approval speed, and CIBIL flexibility. Free EMI calculator and eligibility checker."
        canonical="/"
        schema={[organizationSchema, buildFaqSchema(FAQS)]}
      />
      <style>{`
      ...
      <section
        style={{
          background:
            "linear-gradient(160deg,#E8F0FB 0%,#F0F6FF 50%,#DBEAFE 100%)",
          minHeight: "100svh",
          display: "flex",
          alignItems: "center",
          position: "relative",
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(rgba(21,101,192,0.04) 1px,transparent 1px),linear-gradient(90deg,rgba(21,101,192,0.04) 1px,transparent 1px)",
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle,rgba(21,101,192,0.14),transparent 70%)",
            filter: "blur(50px)",
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle,rgba(2,136,209,0.12),transparent 70%)",
            filter: "blur(60px)",
        ...
        <div
          className="w-full max-w-7xl mx-auto home-pad"
          style={{
            paddingTop: "72px",
            paddingBottom: "72px",
            position: "relative",
          ...
          >
            <div>
              ...
              >
                Compare the best
                <br />
                <span style={{ color: "#1565C0" }}>instant loan apps</span>
                <br />
                in India.
              </motion.h1>
              <motion.p
              ...
              >
                No guesswork. No spam. The clearest side-by-side comparison of
                India's top loan apps — ranked by rate, speed, and CIBIL
                flexibility.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                ...
                className="hero-btns"
              >
                <Link to="/apply" style={{ width: "100%", maxWidth: "240px" }}>
                  <motion.button
                    className="btn-mint"
                    style={{
                      fontSize: "14px",
              ...
              >
                {[
                  ...
                  { val: "30 min", label: "Avg Approval" },
                  { val: "9.9%", label: "Starting Rate" },
                  { val: "12+", label: "Lenders" },
                ].map((s, i) => (
                  <motion.div
                    key={i}
                    style={{
                    ...
                    whileHover={{ background: "rgba(21,101,192,0.06)" }}
                  >
                    <div
                      style={{
                        fontWeight: 800,
        ...
        >
          ...
          >
            <div>
              ...
              >
                India's Top Loan Apps,{" "}
                <span style={{ color: "#1565C0" }}>Ranked.</span>
              </h2>
            </div>
            <Link to="/compare">
              <button
      ...
      <Section className="home-section" style={{ background: "#fff" }}>
        <div className="w-full max-w-7xl mx-auto home-pad">
          <div style={{ textAlign: "center", marginBottom: "36px" }}>
            ...
            <p style={{ color: "#7A90B8", fontSize: "14px", marginTop: "8px" }}>
              All RBI-registered NBFCs and banks. Zero bias.
            </p>
          </div>
          <div
      ...
      >
        ...
        <div
          className="w-full max-w-5xl mx-auto home-pad"
          style={{ position: "relative", zIndex: 10 }}
        >
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <p style={{ color: "#7A90B8", fontSize: "14px", marginTop: "8px" }}>
              Adjust amount, rate and tenure to see your exact EMI instantly
            </p>
          </div>
          <div
            style={{
          ...
          >
            {[
              [
                ...
                "Share loan amount, employment type and CIBIL. Takes 90 seconds.",
                "📝",
              ],
              [
                "02",
                "We match top lenders",
                "Our algorithm ranks lenders by your profile — highest approval odds first.",
                "🎯",
              ],
              [
                "03",
                "Apply with one tap",
                "Click Apply on your preferred lender. Fully guided from start to disbursal.",
                "✅",
              ],
      ...
      >
        <IllustrationDots />
        <div
          className="w-full max-w-4xl mx-auto home-pad"
          style={{ position: "relative", zIndex: 10 }}
        >
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <div
            ...
            <p style={{ color: "#7A90B8", fontSize: "14px", marginTop: "8px" }}>
              Drag the slider to see which lenders can give you that amount
            </p>
          </div>
          <div
            style={{
      ...
      <Section className="home-section" style={{ background: "#fff" }}>
        <div className="w-full max-w-4xl mx-auto home-pad">
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            >
              What loan can you get?
            </h2>
            <p style={{ color: "#7A90B8", fontSize: "14px", marginTop: "8px" }}>
              Your CIBIL score determines which lenders approve you
            </p>
          </div>
          <div
            ...
            {CIBIL_RANGES.map((c, i) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <span style={{ fontWeight: 600 }}>Eligible: </span>
                    {c.lenders}
                  </div>
                </div>
              </motion.div>
                          ...
                          style={{
                            ...
                            background:
                              l.cibil === "Any"
                                ? "rgba(22,163,74,0.1)"
                                : "rgba(21,101,192,0.1)",
                            color: l.cibil === "Any" ? "#16a34a" : "#1565C0",
                          }}
                        >
                          {l.cibil}
                        </span>
      ...
      <Section className="home-section" style={{ background: "#fff" }}>
        <div className="w-full max-w-2xl mx-auto home-pad">
          <div style={{ textAlign: "center", marginBottom: "36px" }}>
            ...
            <p style={{ color: "#7A90B8", fontSize: "14px", marginTop: "8px" }}>
              3 quick questions. Get a personalised lender recommendation.
            </p>
          </div>
          <div
            style={{
              ...
              >
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: "12px", color: "#7A90B8" }}>
                      {c.desc}
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {b.excerpt ||
                            "Read our latest insights on loans, rates and borrowing tips."}
                        </p>
                        <div
                          style={{
                            display: "flex",
      ...
      <Section className="home-section" style={{ background: "#fff" }}>
        <div className="w-full max-w-7xl mx-auto home-pad">
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ color: "#7A90B8", fontSize: "15px" }}>
              Experience the smartest way to find and compare loans in India
            </p>
          </div>
          <div
            style={{
            ...
            {[
              {
                ...
                desc: "Compare 12+ verified lenders in one place with transparent rates, fees and approval times.",
              },
              {
                icon: "🆓",
                bg: "#F0FDF4",
                ...
                desc: "No hidden charges, no fees — completely free comparison platform for every borrower.",
              },
              {
                icon: "🏦",
                bg: "#FFF7ED",
                ...
                desc: "All lenders are RBI-registered and thoroughly verified. No unlicensed apps, ever.",
              },
              {
                icon: "🧮",
                bg: "#FDF4FF",
                ...
                color: "#9333ea",
                title: "Free Tools",
                desc: "EMI calculator, eligibility checker and comparison tools — all free, no signup needed.",
              },
              {
                icon: "⭐",
                bg: "#FFFBEB",
                ...
                desc: "Verified ratings from 1.2 lakh+ borrowers who found their loans through TrueCreds.",
              },
              {
                icon: "📱",
                bg: "#F0F6FF",
                ...
                desc: "Seamlessly compare and apply from any device — phone, tablet or desktop.",
              },
            ].map((f, i) => (
              <motion.div
                key={i}
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "11px", color: "#7A90B8" }}>
                      {t.city}
                    </div>
                  </div>
                </div>
                ...
                {FAQS.map((f, i) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <motion.span
                        style={{ color: "#1565C0", flexShrink: 0 }}
            ...
            <div style={{ position: "sticky", top: "80px" }}>
              ...
              >
                ...
                <div style={{ position: "relative", zIndex: 10 }}>
                  ...
                  >
                    Join 1.2 lakh+ Indians who found their best loan on
                    TrueCreds.
                  </p>
                  <Link to="/apply">
                    <motion.button
                  ...
                  >
                    TrueCreds is NOT a lender. No spam.
                  </p>
                </div>
              </div>
            </div>
